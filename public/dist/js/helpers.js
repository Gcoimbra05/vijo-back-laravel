        ...
        var d = {
            ...
            scrollPageTo: function(e) {
                ...
                var o = n.scrollTop
                  ...
                  , r = +new Date
                  , a = function() {
                    var s, u, l, c = +new Date - r, d = (s = c,
                    u = o,
                    l = i,
                    (s /= t / 2) < 1 ? l / 2 * s * s + u : -l / 2 * ((s -= 1) * (s - 2) - 1) + u);
                    n.scrollTop = d,
            ...
            initPasswordToggle: function() {
                ...
                null != e && e.forEach(function(e) {
                    e.addEventListener("click", function(t) {
                        ...
                        o.classList.replace("ri-eye-line", "ri-eye-off-line")) : "password" === i.getAttribute("type") && (i.setAttribute("type", "text"),
